     ...
     <SafeAreaView className="bg-primary h-full">
      <ScrollView>
        <View className="w-full justify-center items-center min-h-[85vh] px-4 my-6">
          ...
          <Text className="text-2xl text-white text-semibold mt-10 font-psemibold">Sign Up as a service provider</Text>
          <FormField
        title="User Name"
        value={form.username}
        ...
        <Link href="/signIn_vendor" className='text-lg font-semibold text-secondary'>Sign In</Link>
        </View>
        </View>
      </ScrollView>
     </SafeAreaView>
